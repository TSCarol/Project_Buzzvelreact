...
const BuzzvelSec = () => {
  ...
  const handleNextClick = () => {
    setSelectedCardIndex((prevIndex) =>
      (prevIndex + 1) % ProjectsCard.projects.length
    );
  };

  const startCardIndex = Math.floor(selectedCardIndex / cardsPerPage) * cardsPerPage;
  const visibleProjects = ProjectsCard.projects.slice(startCardIndex, startCardIndex + cardsPerPage);
